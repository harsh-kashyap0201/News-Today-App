...
export default class Newscomponent extends Component {
  copyURL=()=>{
    ...
    return (
      <div>
      <div className="card my-3 shadow-lg p-3 mb-5 bg-body rounded" style={{width: "18rem" ,color:"black"}}>
          ...
          <div className="card-body">
            ...
            <a href={readMoreURL} className="btn btn-sm" style={{backgroundColor:"#85dfdf" }} target="_blank" rel="noopener noreferrer"><b>Read More</b></a>
            <button className="btn btn-sm" style={{backgroundColor:"#85dfdf" }} onClick={this.copyURL}><b>Copy Url</b></button>
            </div>
